...
function answer(selection) {
    ...
    document.getElementById('overlay').classList.remove('d-none'); // Overlay erscheint nach Klick auf Frage
}
...
function nextQuestion() {
    ...
    resetButtons();
    document.getElementById('overlay').classList.add('d-none'); // Overlay verschwindet nach Klick auf Button "Nächste Frage".
}
...
function restartGame() {
    ...
    audio_endscreen.currentTime = 0;
    audio_endscreen.pause(); // Musik auschalten mit Klick auf "Erneut spielen".
}
